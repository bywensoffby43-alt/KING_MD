...
// Konfigirasyon dirèk — pa bezwen config.js
const config = {
    botName: 'WENS DEV',
    version: '1.0.0',
...
app.get('/', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .dot { height: 8px; width: 8px; background: var(--primary); border-radius: 50%; margin-right: 8px; }
    ...
    <body>
        <div class="container">
            ...
            <footer>POWERED BY WENS DEV</footer>
        </div>
    </body>
    </html>
    `);
...
// ROUTE PAIRING - 8 CHIF POU WHATSAPP
app.get('/pair', async (req, res) => {
    ...
    res.json({ 
        code: code,
        status: 'success',
        message: '8-digit WhatsApp pairing code'
    });
});
