...
import { getCode } from '../pair.js';

const app = express(); // ✅ FIX: mete an premye

// ✅ route code
app.get('/code', (req, res) => {
    res.json({
        code: getCode() || "waiting..."
    });
});
...
// ✅ FIX: ENPÒTAN POU RENDER
export const PORT = process.env.PORT || 5000;

// ✅ PAGE WEB OU (PA CHANJE)
app.get('/', (req, res) => {
...
// lòt routes ou yo rete menm jan
