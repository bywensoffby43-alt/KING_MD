...
// CORS - pou permet front-end lan kominike ak back-end lan
app.use(cors({
    origin: '*',
...
// ========== ROUTE PAIRING LA - SA KI TE MANKE A ==========
app.get('/pair', async (req, res) => {
    ...
    // Afiche nan logs Render pou wè si tout bagay mache
    console.log(`🔑 Pairing request for ${number} - Code: ${code}`);
